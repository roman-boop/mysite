...
const CURRICULUM = [
  {
    ...
    accentColor: '#f59e0b',
    lessons: [
      { title: 'Что такое криптовалюта', duration: '12 мин' },
      { title: 'Как работает блокчейн', duration: '18 мин' },
      { title: 'Виды криптоактивов', duration: '15 мин' },
      { title: 'Кошельки и биржи', duration: '20 мин' },
      { title: 'Как купить первую крипту', duration: '14 мин' },
    ],
  },
  {
    ...
    accentColor: '#8b5cf6',
    lessons: [
      { title: 'Кто такие Smart Money', duration: '16 мин' },
      { title: 'Ордер-блоки', duration: '24 мин' },
      { title: 'Fair Value Gaps', duration: '19 мин' },
      { title: 'Зоны ликвидности', duration: '22 мин' },
      { title: 'Break of Structure и Change of Character', duration: '28 мин' },
    ],
  },
  {
    ...
    accentColor: '#06b6d4',
    lessons: [
      { title: 'Основы психологии трейдинга', duration: '20 мин' },
      { title: 'Управление страхом и жадностью', duration: '18 мин' },
      { title: 'Построение торговой рутины', duration: '15 мин' },
      { title: 'Работа с убытками', duration: '22 мин' },
      { title: 'Дисциплина и терпение в трейдинге', duration: '17 мин' },
    ],
  },
  {
    ...
    accentColor: '#22c55e',
    lessons: [
      { title: 'Определение торгового стиля', duration: '16 мин' },
      { title: 'Правила входа и выхода', duration: '25 мин' },
      { title: 'Соотношение риск/прибыль', duration: '18 мин' },
      { title: 'Составление торгового плана', duration: '30 мин' },
      { title: 'Комбинирование индикаторов с прайс экшн', duration: '27 мин' },
    ],
  },
  {
    ...
    accentColor: '#f97316',
    lessons: [
      { title: 'Быстрое чтение графиков', duration: '14 мин' },
      { title: 'Ведение торгового журнала', duration: '20 мин' },
      { title: 'Разбор ошибок', duration: '18 мин' },
      { title: 'Адаптация к рыночным условиям', duration: '23 мин' },
      { title: 'Продвинутое чтение потока ордеров', duration: '32 мин' },
    ],
  },
  {
    title: 'Бэктестинг',
    ...
    accentColor: '#ec4899',
    lessons: [
      { title: 'Что такое бэктестинг', duration: '12 мин' },
      { title: 'Ручной vs автоматический бэктестинг', duration: '20 мин' },
      { title: 'Настройка среды для бэктестинга', duration: '35 мин' },
      { title: 'Анализ результатов бэктеста', duration: '28 мин' },
      { title: 'Оптимизация стратегии на основе данных', duration: '30 мин' },
    ],
  },
];
