...
export async function GET() {
  try {
    ...
    // Read latest funding signals from cache
    ...
    if (error) {
      console.error('[Market/Funding] Cache read error:', error.message);
    ...
    console.error('[Market/Funding] GET handler error:', err?.message ?? err);
